...
stable version is `1.1.1-kroog.2`; modules which apply a beta version transform
...
snapshot version is `1.1.1-beta-kroog.2-SNAPSHOT`, and its release version is
`1.1.1-beta-kroog.2`. It remains excluded from `koog-agents` and

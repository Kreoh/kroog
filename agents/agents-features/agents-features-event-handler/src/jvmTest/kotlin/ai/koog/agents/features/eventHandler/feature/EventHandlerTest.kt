...
class EventHandlerTest {
    ...
    fun `test event handler single node without tools`() = runTest {
        ...
        val expectedAssistantMessage =
            "Assistant(parts=[Text(text=Default test response, cacheControl=null, providerItemId=null, generatedFileCitations=[])], metaInfo=ResponseMetaInfo(timestamp=$ts, totalTokensCount=null, inputTokensCount=null, outputTokensCount=null, modelId=null, metadata=null, cacheReadTokensCount=null, cacheWriteTokensCount=null, reasoningTokensCount=null), finishReason=null, rawResponse=null, id=null)"
    ...
    fun `test event handler single node with tools`() = runTest {
        ...
        val toolCallAssistantObj =
            "Assistant(parts=[Call(id=null, tool=$dummyToolName, args=$dummyToolArgsEncoded, cacheControl=null, providerItemId=null)], metaInfo=ResponseMetaInfo(timestamp=$ts, totalTokensCount=null, inputTokensCount=null, outputTokensCount=null, modelId=null, metadata=null, cacheReadTokensCount=null, cacheWriteTokensCount=null, reasoningTokensCount=null), finishReason=null, rawResponse=null, id=null)"
        val toolCallsInput =
        ...
        val finalAssistantObj =
            "Assistant(parts=[Text(text=$mockResponse, cacheControl=null, providerItemId=null, generatedFileCitations=[])], metaInfo=ResponseMetaInfo(timestamp=$ts, totalTokensCount=null, inputTokensCount=null, outputTokensCount=null, modelId=null, metadata=null, cacheReadTokensCount=null, cacheWriteTokensCount=null, reasoningTokensCount=null), finishReason=null, rawResponse=null, id=null)"
    ...
    fun `test event handler several nodes`() = runTest {
        ...
        val expectedAssistantMessage =
            "Assistant(parts=[Text(text=$defaultResponse, cacheControl=null, providerItemId=null, generatedFileCitations=[])], metaInfo=ResponseMetaInfo(timestamp=$ts, totalTokensCount=null, inputTokensCount=null, outputTokensCount=null, modelId=null, metadata=null, cacheReadTokensCount=null, cacheWriteTokensCount=null, reasoningTokensCount=null), finishReason=null, rawResponse=null, id=null)"
    ...
    fun `test llm streaming events success`() = runTest {
        ...
        val expectedEvents = listOf(
            ...
            "OnLLMStreamingFrameReceived (run id: $runId, frame: End(finishReason=null, metaInfo=ResponseMetaInfo(timestamp=$ts, totalTokensCount=null, inputTokensCount=null, outputTokensCount=null, modelId=null, metadata=null, cacheReadTokensCount=null, cacheWriteTokensCount=null, reasoningTokensCount=null), messageId=null))",
